/*******************************************************************************
  Filename:       Controller_ConnCtrl.c
 ...
 * PROFILE CALLBACKS
 */
static ccCBs_t Controller_ccCBs =
{
...
/*******************************************************************************
 * @fn      ControllerConnectionControl_init
 *
 * @brief   Initialization function for the Controller keys
 *
 */
void ControllerConnectionControl_init(void)
{
  // Add service
  CcService_addService();
  CcService_registerAppCBs(&Controller_ccCBs);
}

/*******************************************************************************
 * @fn      ControllerConnectionControl_update
 *
 * @brief   Update the Connection Control service with the current connection
 *          control settings
 *
 */
void ControllerConnectionControl_update(void)
{
...
/*******************************************************************************
 * @fn      ControllerConnControl_processCharChangeEvt
 *
 * @brief   Process a change in the connection control characteristics
 *
 * @return  none
 */
void ControllerConnControl_processCharChangeEvt(uint8_t paramID)
{
...
/*******************************************************************************
 * @fn      ControllerConnControl_paramUpdateCB
 *
 ...
 * @return  none
*/
void ControllerConnControl_paramUpdateCB(uint16_t connInterval, 
...
static void ccChangeCB(uint8_t paramID)
{
  ...
  Controller_charValueChangeCB(SERVICE_ID_CC, paramID);
}
