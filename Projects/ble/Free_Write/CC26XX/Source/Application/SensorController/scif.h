/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     Sensor Controller
  * - <b>Project file</b>:     C:/ti/simplelink/ble_cc26xx_2_01_01_44627/Projects/ble/Controller_NOAD/CC26XX/SensorController/SensorController.scp
  * - <b>Code prefix</b>:      -
  * - <b>Operating system</b>: TI-RTOS
  * - <b>Tool version</b>:     1.3.1.42689
  * - <b>Tool patches</b>:     1
  * - <b>Target chip</b>:      CC2650, revision -, package QFN48 7x7 RGZ
  * - <b>Created</b>:          2016-12-26 14:10:54.040
  * - <b>Computer</b>:         WOLF
  * - <b>User</b>:             Fang Teacher
  *
  ...
  * Demonstrates capacitive touch data sampling on the CC2650 Controller
  * 
  * The TDC data (i.e. the time taken to charge up each capacitive area from 0 to 0.8 V) for button and
  * slider are output to the System CPU application.
  ...
  * - Capacitive Touch Data Logger:
  *     - <b>AXD: Capacitive Touch Pins 0</b>: DIO25
  *     - <b>AXD: Capacitive Touch Pins 1</b>: DIO24
  *     - <b>AXD: Capacitive Touch Pins 2</b>: DIO23
  *
  *
  ...
  *
  *
  * \subsection section_task_desc_capacitive_touch_data_logger Capacitive Touch Data Logger
  * Samples capacitive touch Pins on the CC2650 Controller
  * 
  * The TDC data (i.e. the time taken to charge up each capacitive area from 0 to 0.8 V) are output to
  * the System CPU. This includes raw data and IIR-filtered data.
  *
  */
...
/// Capacitive Touch Data Logger: Task ID
#define SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_TASK_ID 0


/// Capacitive Touch Data Logger: Capactive touch pin count
#define SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_PIN_COUNT 3
/// Capacitive Touch Data Logger I/O mapping: Capacitive Touch Pins
#define SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_DIO_AXD_CAP_TOUCH { 25, 24, 23 }
...
/// Capacitive Touch Data Logger: Task configuration structure
typedef struct {
    uint16_t pAuxioAxdCapTouch[3]; ///< I/O mapping: Capacitive Touch Pins
} SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_CFG_T;


/// Capacitive Touch Data Logger: Task output data structure
typedef struct {
    uint16_t pTdcValueFilt[3]; ///< TDC value, filtered
    uint16_t pTdcValueRaw[3];  ///< TDC value, raw
} SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_OUTPUT_T;


/// Capacitive Touch Data Logger: Task state structure
typedef struct {
    uint16_t filtInitDone; ///< Has the value filtering been initialized?
} SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_STATE_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_CFG_T cfg;
        uint16_t outputSceBufferCtrl;
        uint16_t outputDrvBufferCtrl;
        uint16_t outputScePtr;
        SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_OUTPUT_T pOutput[2];
        SCIF_CAPACITIVE_TOUCH_DATA_LOGGER_STATE_T state;
    } capacitiveTouchDataLogger;
} SCIF_TASK_DATA_T;
